...
@Entity
@NamedQueries({ @NamedQuery(name = "PessoaJuridica.buscarTodos", query = " select pj from PessoaJuridica pj "
		+ " left join fetch pj.classifEntidade ")
...
public class PessoaJuridica extends Entidade{
	...
	@Column(name = "ret")
	private String retministerioAgricultura;
	@Column(name = "simples_nacional")
	private Boolean simplesNacional;
	@Column(name = "contribuinte_icms")
	private Boolean contribuinteIcms;
	@Column(name = "icms_diferimento")
	private Boolean icmsDiferimento;
	...
	public String getRetministerioAgricultura() {
		return retministerioAgricultura;
	}

	public void setRetministerioAgricultura(String retministerioAgricultura) {
		this.retministerioAgricultura = retministerioAgricultura;
	}
	...
	public Boolean getIcmsDiferimento() {
		return icmsDiferimento;
	}

	public void setIcmsDiferimento(Boolean icmsDiferimento) {
		this.icmsDiferimento = icmsDiferimento;
	}
