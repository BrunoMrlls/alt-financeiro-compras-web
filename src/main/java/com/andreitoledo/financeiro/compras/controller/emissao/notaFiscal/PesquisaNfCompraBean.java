...
@Named
@ViewScoped
public class PesquisaNfCompraBean implements Serializable {
	...
	public void inicializar() {
		this.nfCompras = this.nfCompraDAO.buscarTodos();
	...
	public void excluir() {
		try {
			...
			facesMessages.info("Nota de Compra "
					+ nfCompraSelecionado.getCodigo()
